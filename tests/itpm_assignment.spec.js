...
const testScenarios = [
  ...
  { id: 'Pos_Fun_0023', name: 'Line Break', input: 'ape group project eka iwara karanna oni nisa mama me list eka hadhuva.  1. Oyage kalla ivara karala mata code eka evanna. 2. Mama frontend eka design karala meka complete karannam.  3. Heta ude  set vela okkoma merge karala balamu.  4. iita passe apita report eka hadhala submission eka dhanna puluvan veyi. Me vaeda tika tika kaloth apita exam valata paadam karannath kalaya ithiri vaeyi kiyala mama hithanava. naethi nam anthima mohothe api godak amaruve vaetenna puluvan needha', expected: 'ape group project එක ඉwඅර කරන්න ඔනි නිස මම මෙ list එක හදුව.  1. ඔයගෙ කල්ල ඉවර කරල මට code එක එවන්න. 2. මම ෆ්‍රොන්ටෙන්ඩ් එක design කරල මෙක complete කරන්නම්.  3. හෙට උඩෙ  සෙට් වෙල ඔක්කොම merge කරල බලමු.  4. ඊට පස්සෙ අපිට report එක හදල submission එක දන්න පුලුවන් වෙයි. මෙ වැඩ ටික ටික කලොත් අපිට exam වලට පාඩම් කරන්නත් කලය ඉතිරි වැයි කියල මම හිතනව. නැති නම් අන්තිම මොහොතෙ අපි ගොඩක් අමරුවෙ වැටෙන්න පුලුවන් නේද' },
  ...
  { id: 'Neg_Fun_0005', name: 'Semantic Translation Fail', input: 'mama game ekafinish kra', expected: 'මම game එක ඉවර කළා' }, 
